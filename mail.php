...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $content = $name . ' оставил заявку на бронирование тура для ' . $count . ' человек(а). Контактный телефон: ' . $phone;

    // Первый параметр - кому отправляем письмо, второй - тема письма, третий - содержание
    $success = mail("reservation@Iceland.travel", 'Запрос на бронирование тура', $content);
